...
public class CommandManager implements TabExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command cmd, @NotNull String label, String[] args) {
        try {
            ...
            MMOSpawnPoint.getInstance().getMessageManager().sendMessage(sender, tmpl, "err", (e.getMessage() != null ? e.getMessage() : "unknown"));
        }
        return true;
    }
    ...
    private void executeCommandPath(CommandSender sender, CommandPath path, String[] args) {
        ...
        if (path.permission != null && !sender.hasPermission(path.permission)) {
            ...
            MMOSpawnPoint.getInstance().getMessageManager().sendMessage(sender, tmpl, "perm", path.permission);
            return;
        }
    ...
    private void showHelp(CommandSender sender, CommandPath path) {
        MMOSpawnPoint.getInstance().getMessageManager().sendMessage(sender,
