    ...
    public SubCommandBuilder build(SubCommandBuilder parent) {
        return parent.subcommand("death")
                ...
                .executor((sender, ctx) -> {
                    ...
                    if (ok) {
                        if (sender.equals(target)) plugin.getMessageManager().sendMessage(sender, msg.deathSelf);
                        else plugin.getMessageManager().sendMessage(sender, msg.deathOther, "player", target.getName());
                    } else {
