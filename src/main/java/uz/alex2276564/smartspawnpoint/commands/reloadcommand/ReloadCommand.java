package uz.alex2276564.smartspawnpoint.commands.reloadcommand;
...
public class ReloadCommand extends LongCommandExecutor {
    ...
    public ReloadCommand() {
        addSubCommand(new uz.alex2276564.smartspawnpoint.commands.reloadcommand.list.ReloadCommandExecutor(), new String[] {"reload"}, new Permission("smartspawnpoint.reload"));
    }
