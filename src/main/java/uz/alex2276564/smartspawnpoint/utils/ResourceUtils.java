...
public class ResourceUtils {
     ...
     */
    public static boolean copyResource(SmartSpawnPoint plugin, String resourcePath, File destination) {
     ...
     */
    public static boolean copyResourceIfNotExists(SmartSpawnPoint plugin, String resourcePath, File destination) {
     ...
     */
    public static boolean updateFromResource(SmartSpawnPoint plugin, String resourcePath, File destination) {
        if (destination.exists()) {
            destination.delete();
        }
        return copyResource(plugin, resourcePath, destination);
     ...
     */
    public static String getResourceAsString(SmartSpawnPoint plugin, String resourcePath) {
        try (InputStream inputStream = plugin.getResource(resourcePath)) {
            if (inputStream == null) {
                plugin.getLogger().warning("Resource not found: " + resourcePath);
                return null;
     ...
     */
    public static boolean copyResourceToDirectory(SmartSpawnPoint plugin, String resourcePath, File directory) {
     ...
     */
    public static void copyResources(SmartSpawnPoint plugin, String[] resourcePaths, File directory) {
     ...
     */
    public static boolean resourceExists(SmartSpawnPoint plugin, String resourcePath) {
        try (InputStream inputStream = plugin.getResource(resourcePath)) {
