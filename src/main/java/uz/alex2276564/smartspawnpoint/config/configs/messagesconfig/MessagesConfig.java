...
public class MessagesConfig extends OkaeriConfig {
    ...
    @Comment("# ================================================================")
    @Comment("# 📝 SmartSpawnPoint Messages Configuration")
    @Comment("#")
    ...
    public static class CommandsSection extends OkaeriConfig {
        ...
        public static class HelpSection extends OkaeriConfig {
            ...
            public String header = "<gold>=== SmartSpawnPoint Help ===";
        ...
        public static class ReloadSection extends OkaeriConfig {
            ...
            public String success = "<green>SmartSpawnPoint configuration successfully reloaded (<type>).";
    ...
    public static class PartySection extends OkaeriConfig {
        @Comment("Colors: You can use MiniMessage tags for formatting")
        ...
        public String inviteDeclined = "<red><player> <gray>has rejected the soul bond";
        public String inviteExpired = "<gray>The soul bond invitation has faded into darkness";
        public String partyJoined = "<red><player> <gray>has joined your death party!";
        public String partyLeft = "<gray><player>'s <gray>soul has departed from the party";
        public String playerKicked = "<red><player> <gray>has been cast out from the death party";
        public String playerNotFound = "<gray>Lost soul not found or wandering offline";
        ...
        public String playerNotInParty = "<red>This soul is not bound to your death party";
        public String leaderChanged = "<red><player> <gray>now commands the death party";
