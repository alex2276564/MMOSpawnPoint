package uz.alex2276564.smartspawnpoint.config.configs.mainconfig;
        ...
        if (settings.unsafeMaterials != null) {
            for (String material : settings.unsafeMaterials) {
                try {
                    ...
                    SmartSpawnPoint.getInstance().getLogger().warning("Warning: Unknown material in unsafe-materials list: " + material);
                }
            }
        }
    }
